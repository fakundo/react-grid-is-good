...
var Grid = function (_Component) {
  ...
  Grid.prototype.getGridPropValue = function getGridPropValue(name) {
    var breakpoint = this.props.breakpoint;

    return (0, _utils.getPropValue)(name, breakpoint, this.props);
  };

  Grid.prototype.getSpanWidth = function getSpanWidth(spanProps, gridSize) {
    var breakpoint = this.props.breakpoint;
  ...
  Grid.prototype.getSpanBreak = function getSpanBreak(spanProps) {
    var breakpoint = this.props.breakpoint;

    return (0, _utils.getPropValue)('break', breakpoint, spanProps);
  };

  Grid.prototype.getStyles = function getStyles() {
  ...
  Grid.prototype.renderStyleTag = function renderStyleTag() {
